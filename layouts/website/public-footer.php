    ...
    <div class="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        ...
        <div class="pt-8 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="text-[10px] md:text-xs text-slate-400 text-center md:text-left">
                &copy; 2025 <span class="text-slate-600 font-semibold uppercase tracking-wider">Gyanmanjari
                    Vidhyapith</span>. All rights reserved.
            </p>
            <div class="flex items-center space-x-6">
                ...
                <a href="<?php echo BASE_URL; ?>/portal/website/digital-wallet-policy.php"
                    class="text-[10px] uppercase tracking-[0.2em] text-slate-400 hover:text-blue-600 transition-colors">Wallet Policy</a>
                <a href="#"
