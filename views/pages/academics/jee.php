        ...
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="text-center mb-12 md:mb-20">
                ...
                <h1 class="text-3xl md:text-4xl lg:text-6xl font-black mb-3 md:mb-4">
                    <span class="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600">JEE Preparation Program</span>
                </h1>
                <p class="text-gray-500 text-sm md:text-base lg:text-lg max-w-2xl mx-auto px-4">Empowering students to conquer national-level engineering entrance exams with confidence.</p>
            </div>
            ...
            <div class="max-w-6xl mx-auto mb-12 md:mb-24">
                <div class="bg-white rounded-[2rem] md:rounded-[2.5rem] shadow-2xl overflow-hidden">
                    <div class="flex flex-col lg:flex-row">
                        <!-- Image Side -->
                        <div class="lg:w-1/2 p-4 md:p-6 lg:p-8 bg-gradient-to-br from-blue-50 to-indigo-50/50 flex items-center justify-center">
                            <div class="relative group">
                                <div class="absolute -inset-1 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl opacity-25 group-hover:opacity-40 blur transition duration-300"></div>
                                <img src="../assets/images/jee result.jpeg" alt="JEE Success" class="relative rounded-2xl w-full h-auto object-cover border-4 border-white shadow-xl">
                            </div>
                        </div>

                        <!-- Content Side -->
                        <div class="lg:w-1/2 p-6 md:p-8 lg:p-12 flex flex-col justify-center">
                            <h2 class="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Mastering Joint Entrance Examination</h2>
                            <div class="space-y-4 md:space-y-6">
                                <p class="text-gray-700 text-sm md:text-base lg:text-lg leading-relaxed">
                                    Gyanmanjari Vidyapith takes the initiative for the students' future careers. We offer dedicated classes for the <span class="text-blue-600 font-semibold text-lg">JEE exam</span> (for Group A) and NEET (for Group B), ensuring every student receives specialized attention.
                                </p>
                                <p class="text-gray-700 text-sm md:text-base lg:text-lg leading-relaxed">
                                    Our platform features highly expert faculty with <span class="text-indigo-600 font-semibold">15-20 years of experience</span> in national-level examinations, providing a full-fledged ecosystem for science aspirants.
                                </p>
            ...
            <div class="max-w-4xl mx-auto mb-12 md:mb-24 text-center">
                <div class="bg-gradient-to-br from-gray-900 to-indigo-950 rounded-[2rem] md:rounded-[2.5rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-gray-300 text-base md:text-lg leading-relaxed mb-8">
                            We take pride in our consistent results across Gujarat. In 2012, our students achieved remarkable victory in AIEEE, and our success story continues.
                        </p>
                        <div class="flex flex-wrap justify-center gap-6">
                            <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 flex-1 min-w-[200px]">
                                ...
                                <div class="text-blue-300 text-sm font-bold uppercase tracking-widest">Students Selected</div>
                            </div>
                            <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 flex-1 min-w-[200px]">
                                <div class="text-3xl font-black text-white mb-2">Top Rank</div>
                                <div class="text-blue-300 text-sm font-bold uppercase tracking-widest">Doshi Chintan</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="text-center">
                ...
                <a href="../contact.php" class="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-full shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 group">
