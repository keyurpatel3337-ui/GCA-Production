...
<body class="text-gray-800">
    ...
    <section class="relative py-12 md:py-24 overflow-hidden bg-gradient-to-b from-white via-green-50/30 to-white">
        ...
        <div class="absolute top-0 right-0 w-96 h-96 bg-green-100 rounded-full translate-x-1/2 -translate-y-1/2 opacity-20 animate-float css-playground-f165c4"></div>
        <div class="absolute bottom-0 left-0 w-64 h-64 bg-lime-100 rounded-full -translate-x-1/2 translate-y-1/2 opacity-20 animate-float css-playground-bd845f"></div>
        <div class="absolute top-1/4 left-10 w-40 h-40 bg-yellow-100 rounded-full opacity-15 animate-float css-playground-cffe64"></div>
