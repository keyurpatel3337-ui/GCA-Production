...
<body class="text-gray-800">
    ...
    <section class="relative py-12 md:py-24 overflow-hidden bg-gradient-to-b from-white via-amber-50/30 to-white">
        ...
        <div class="absolute top-0 right-0 w-96 h-96 bg-amber-100 rounded-full translate-x-1/2 -translate-y-1/2 opacity-20 animate-float" style="animation-delay: 0s;"></div>
