...
<body class="text-gray-800">
    ...
    <section class="relative py-12 md:py-24 overflow-hidden bg-gradient-to-b from-white via-blue-50/30 to-white">
        ...
        <div class="absolute top-1/2 right-10 w-40 h-40 bg-sky-100 rounded-full opacity-15 animate-float"
        ...
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="text-center mb-16 md:mb-24">
                <div
                    class="inline-block px-4 py-1.5 mb-4 bg-blue-50 text-blue-600 rounded-full text-sm font-bold tracking-wide uppercase">
                    Our Legacy
                </div>
                ...
                <p class="text-gray-500 text-lg md:text-xl max-w-3xl mx-auto">A sanctuary of learning where heritage
                    meets innovation, dedicated to shaping the leaders of tomorrow.</p>
            </div>
                ...
                <div class="bg-white rounded-[2.5rem] shadow-2xl overflow-hidden border border-blue-50">
                    <div class="flex flex-col lg:flex-row">
                        <div class="lg:w-1/2 relative group overflow-hidden">
                            <img src="../assets/images/gmbuilding.jpg" alt="Our History"
                                class="w-full h-full object-cover transition duration-700 group-hover:scale-110 min-h-[400px]">
                            <div
                        ...
                        <div class="lg:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col justify-center">
                            ...
                            <p class="text-gray-700 text-lg leading-relaxed mb-6">
                                Established in June 2006, our institution began with a profound vision: to provide a
                                nurturing and intellectually stimulating environment where students could thrive.
                            </p>
                            <p class="text-gray-700 text-lg leading-relaxed">
                                Over the decades, we have consistently adapted to the evolving educational landscape,
                                integrating modern pedagogical approaches while retaining our core values of discipline,
            ...
            <div class="max-w-6xl mx-auto mb-20 md:mb-32 grid grid-cols-1 lg:grid-cols-2 gap-8">
                <!-- Mission -->
                <div
                    class="bg-gradient-to-br from-blue-600 to-blue-700 rounded-[2.5rem] p-10 md:p-14 text-white shadow-2xl relative overflow-hidden group">
                    <div
                        class="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full translate-x-1/2 -translate-y-1/2 group-hover:scale-150 transition duration-700">
                    </div>
                    <div class="relative z-10">
                        ...
                        <p class="text-xl leading-relaxed text-blue-50 italic">
                            "To be the center for elevating humanity through Science Success, Spirituality, Nationality
                ...
                <!-- Vision -->
                <div
                    class="bg-gradient-to-br from-indigo-600 to-indigo-700 rounded-[2.5rem] p-10 md:p-14 text-white shadow-2xl relative overflow-hidden group">
                    <div
                        class="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full translate-x-1/2 -translate-y-1/2 group-hover:scale-150 transition duration-700">
                    </div>
                    <div class="relative z-10">
                        ...
                        <p class="text-xl leading-relaxed text-indigo-50 italic">
                            "To achieve the envisaged vision, we will strive to prepare standard practices and execute
                            them with best practices and all stakeholders will inculcate character to make our vision
                            possible."
                        </p>
                    </div>
                </div>
            ...
            <div class="max-w-6xl mx-auto mb-20 md:mb-32">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div
                        class="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl border border-blue-50 flex flex-col items-center text-center">
                    ...
                    <div
                        class="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl border border-indigo-50 flex flex-col items-center text-center">
                        ...
                        <p class="text-gray-600 text-lg">Gyanmanjari Career Academy � Coaching students across Gujarat
                            to secure top national ranks.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div
                        class="bg-white p-8 rounded-[2rem] shadow-lg border border-gray-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group">
                        <div
                            class="w-14 h-14 bg-blue-50 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:bg-blue-600 transition-colors duration-300">
                        ...
                        <p class="text-gray-500 leading-relaxed text-center">Committed to the highest standards in
                            academics and personal development.</p>
                    </div>
                    <div
                        class="bg-white p-8 rounded-[2rem] shadow-lg border border-gray-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group">
                        <div
                            class="w-14 h-14 bg-indigo-50 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:bg-indigo-600 transition-colors duration-300">
                        ...
                        <p class="text-gray-500 leading-relaxed text-center">Upholding honesty, respect, and ethical
                            conduct in all endeavors.</p>
                    </div>
                    <div
                        class="bg-white p-8 rounded-[2rem] shadow-lg border border-gray-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group">
                        <div
                            class="w-14 h-14 bg-sky-50 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:bg-sky-600 transition-colors duration-300">
                        ...
                        <p class="text-gray-500 leading-relaxed text-center">Encouraging creativity, critical thinking,
                            and forward-thinking.</p>
                    </div>
                </div>
            </div>
        </div>
