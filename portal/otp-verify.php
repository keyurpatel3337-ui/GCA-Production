...
<body>
    ...
    <script>
        ...
        form.addEventListener('submit', (e) => {
            ...
            if (otp.length !== 6) {
                e.preventDefault();
                // Show inline error since footer.php is not loaded on this standalone page
                let errDiv = document.querySelector('.error-inline');
                if (!errDiv) {
                    errDiv = document.createElement('div');
                    errDiv.className = 'error error-inline';
