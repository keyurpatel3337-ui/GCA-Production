...
<head>
    ...
    <link rel="stylesheet" href="<?php echo PORTAL_URL; ?>/assets/css/login.css">
</head>
    ...
    <div class="login-container">
        ...
        <div class="login-panel">
            ...
            <form method="POST" action="login.php">
                ...
                <div class="form-group login-custom-1">
                    <input type="checkbox" name="trust_device" id="trust_device" class="login-custom-2">
                    <label for="trust_device" class="login-custom-3">Trust this device for 7 days</label>
                </div>
