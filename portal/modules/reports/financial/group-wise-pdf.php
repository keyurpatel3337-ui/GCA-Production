<?php
/**
 * Group-wise Collection PDF Export
 */
...
try {
    ...
    $groupData = $dbOps->customSelect($sql, [$from_date, $to_date]);
    ...
    $pdf->SetTitle('Group-wise Collection');
    ...
    if (ob_get_length())
        ob_clean();
    $filename = 'Group_wise_Collection_' . $from_date . '_to_' . $to_date . '.pdf';
