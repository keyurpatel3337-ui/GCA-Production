...
<div class="container-fluid py-4">
    ...
    <?php if (isset($results['context'])): $ctx = $results['context']; ?>
    <div class="row mb-4">
        <div class="col-12">
                    ...
                    <table class="table align-middle mb-0">
                        ...
                        <tbody>
                            <?php foreach ($pending_updates as $index => $update): 
                                ...
                                if ($similarity >= 95) { $status_class = "success"; $status_text = "Exact Match"; }
                                elseif ($similarity >= 85) { $status_class = "primary"; $status_text = "Likely Match"; }
                                elseif ($similarity < 50) { $status_class = "danger"; $status_text = "Critical Mismatch"; }
                            ?>
                                    ...
                                    <table class="table table-sm table-borderless mb-0 bg-transparent">
                                        ...
                                        <tr>
                                            ...
                                            <td class="small py-0 <?php echo $diff ? 'text-danger fw-bold bg-warning-light' : ''; ?>">
                                                ...
                                                <?php if ($diff): ?> <i class="fas fa-caret-left ms-1"></i> <?php endif; ?>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </table>
