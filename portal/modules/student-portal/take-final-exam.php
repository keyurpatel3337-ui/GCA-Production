...
<body class="exam-body-secure">
    <!-- Offline HUD warning -->
    <div id="offline-toast" class="css-take-final-exam-31d13f">
    ...
    <div id="proctor-modal" class="css-take-final-exam-8ef759">
        <div class="css-take-final-exam-1c874c">
            <div class="css-take-final-exam-f76446">
                <i class="fas fa-shield-alt fa-3x"></i>
            </div>
            <h2 class="css-take-final-exam-13a6d4">Proctored Examination Mode</h2>
            <p class="css-take-final-exam-02f5c1">
                This test requires full screen mode. Window switching, copying, and tab switching are strictly blocked and monitored.
            </p>
            <button onclick="enterProctoredMode()" class="css-take-final-exam-7f45b6">
    ...
    <header class="exam-header">
        <div class="d-flex align-items-center">
            ...
            <span class="badge badge-secondary ml-3 py-1 px-2 css-take-final-exam-af89d6">Terminal Mode</span>
        </div>
        ...
        <div class="d-flex align-items-center">
            ...
            <button onclick="confirmFinish()" class="btn btn-danger font-weight-bold px-4 css-take-final-exam-97ff4c">
                Submit Exam
            </button>
        </div>
    </header>
        ...
        <div class="col-md-9 question-panel">
            <div class="max-w-4xl mx-auto" id="question-container">
                <div class="question-card">
                    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap css-take-final-exam-651c59">
                        <div>
                        ...
                        <!-- Language Toggle -->
                        <div class="d-flex align-items-center css-take-final-exam-1644f1">
                            <div class="btn-group btn-group-toggle shadow-sm css-take-final-exam-2e0d88" data-toggle="buttons">
                                <label class="btn btn-sm btn-light active css-take-final-exam-ef2115" id="lbl-lang-en">
                                    <input type="radio" name="exam_lang" id="lang-en" autocomplete="off" checked onclick="toggleExamLanguage('en')"> English
                                </label>
                                <label class="btn btn-sm btn-light css-take-final-exam-ef2115" id="lbl-lang-gu">
                ...
                <!-- Navigation Controls -->
                <div class="d-flex justify-content-between align-items-center mt-4 flex-wrap css-take-final-exam-2a1170">
                    <button onclick="prevQuestion()" class="btn btn-outline-secondary px-4 py-2 font-weight-bold css-take-final-exam-1033dd">
                        <i class="fas fa-chevron-left mr-2"></i> Previous
                    </button>
                    <div class="d-flex align-items-center css-take-final-exam-1644f1">
                        <button onclick="clearResponse()" class="btn btn-outline-warning px-3 py-2 font-weight-bold css-take-final-exam-1033dd">
                            <i class="fas fa-eraser mr-1"></i> Clear Response
                        </button>
                        <button onclick="markForReview()" class="btn btn-outline-primary px-3 py-2 font-weight-bold css-take-final-exam-fcb25e">
                            <i class="fas fa-bookmark mr-1"></i> Mark for Review
                        </button>
                    </div>
                    <button onclick="saveAndNext()" class="btn btn-teal px-5 py-2 font-weight-bold text-white css-take-final-exam-76ddd2">
        ...
        <div class="col-md-3 sidebar-panel">
            <div>
                ...
                <div class="status-legends">
                    ...
                    <div class="legend-item">
                        <div class="legend-color css-take-final-exam-cbce63"></div>
                        <span>Marked for Review</span>
                    </div>
                    <div class="legend-item">
                        <div class="legend-color rgba-teal css-take-final-exam-e99e9d"></div>
                        <span>Active</span>
                    </div>
                    <div class="legend-item">
                        <div class="legend-color css-take-final-exam-78b065"></div>
                        <span>Not Visited</span>
                    </div>
                </div>
            </div>
            
            <div class="text-center text-muted small mt-4 pt-3 css-take-final-exam-0957f9">
        ...
        function logViolation(message) {
            ...
            if (remaining <= 0) {
                ...
                Swal.fire({
                    ...
                    html: `${message}<br><br><span class="css-take-final-exam-3ea9df">Warnings remaining: ${remaining}</span>`,
        ...
        function loadQuestion(idx) {
            ...
            container.innerHTML = `<div class="row">` + options.map(opt => {
                ...
                <div class="col-md-6 mb-3">
                    <div onclick="selectOption('${opt}')" id="opt-${opt}" class="option-item ${responses[q.id]?.selected == opt ? 'selected' : ''} css-take-final-exam-33ef3a">
