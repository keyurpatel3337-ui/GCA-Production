...
<main class="app-main">
    <div class="app-content pt-4">
        <div class="container-fluid">
            <div class="card shadow-sm mb-4 border-0 css-add-chapter-d2718c">
                <div class="card-header bg-white border-0 py-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="manage-chapters.php" class="btn btn-sm btn-light shadow-sm css-add-chapter-1033dd"><i class="fas fa-arrow-left mr-1"></i> Back</a>
                    </div>
                </div>
                <div class="card-body p-4">
                    <form method="POST">
                        <div class="form-group mb-4">
                            ...
                            <select id="modal_standard_id" class="form-control border-0 shadow-sm css-add-chapter-18bd7b" onchange="loadSubjects(this.value)">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="subject_id" id="modal_subject_id" class="form-control border-0 shadow-sm css-add-chapter-18bd7b" required>
                        ...
                        <div class="form-group mb-5">
                            ...
                            <input type="text" name="chapter_name" class="form-control border-0 shadow-sm css-add-chapter-18bd7b" value="<?php echo htmlspecialchars($chapter['chapter']); ?>" required>
                        </div>
                        
                        <div class="d-flex justify-content-end gap-2">
                            <a href="manage-chapters.php" class="btn btn-light shadow-sm px-4 css-add-chapter-8925b1">Cancel</a>
                            <button type="submit" class="btn btn-primary shadow-sm px-4 css-add-chapter-756f01">Save Chapter</button>
                        </div>
                    </form>
                </div>
            </div>
