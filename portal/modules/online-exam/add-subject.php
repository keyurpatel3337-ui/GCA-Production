...
<main class="app-main">
    <div class="app-content pt-4">
        <div class="container-fluid">
            <div class="card shadow-sm mb-4 border-0 css-add-subject-d2718c">
                <div class="card-header bg-white border-0 py-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="manage-subjects.php" class="btn btn-sm btn-light shadow-sm css-add-subject-1033dd"><i class="fas fa-arrow-left mr-1"></i> Back</a>
                    </div>
                </div>
                <div class="card-body p-4">
                    <form method="POST">
                        <div class="form-group mb-4">
                            ...
                            <select name="standard_id" class="form-control border-0 shadow-sm css-add-subject-18bd7b">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="subject_name" class="form-control border-0 shadow-sm css-add-subject-18bd7b" value="<?php echo htmlspecialchars($subject['subject_name']); ?>" required>
                        </div>
                        <div class="form-group mb-5">
                            <label class="small font-weight-bold text-muted mb-2">Status <span class="text-danger">*</span></label>
                            <select name="status" class="form-control border-0 shadow-sm css-add-subject-18bd7b" required>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="manage-subjects.php" class="btn btn-light shadow-sm px-4 css-add-subject-8925b1">Cancel</a>
                            <button type="submit" class="btn btn-primary shadow-sm px-4 css-add-subject-756f01">Save Subject</button>
                        </div>
                    </form>
                </div>
            </div>
