...
<main class="app-main">
    <div class="app-content pt-4">
        <div class="container-fluid">
            <div class="card shadow-sm mb-4 border-0 css-import-chapters-d2718c">
                <div class="card-header bg-white border-0 py-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="manage-chapters.php" class="btn btn-sm btn-light shadow-sm css-import-chapters-1033dd"><i class="fas fa-arrow-left mr-1"></i> Back</a>
                    </div>
                </div>
                <div class="card-body p-4">
                    
                    <div class="alert border-0 mb-4 d-flex align-items-start css-import-chapters-4ad229">
                    ...
                    <div class="text-center mb-4">
                        <a href="download-sample.php?type=chapter" class="btn btn-outline-primary shadow-sm css-import-chapters-186171">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="form-group mb-5">
                            ...
                            <div class="custom-file css-import-chapters-e09a76">
                                <input type="file" name="csv_file" class="form-control border-0 shadow-sm css-import-chapters-e8db52" accept=".csv" required>
                            </div>
                        </div>
                        
                        <div class="d-flex justify-content-end gap-2">
                            <a href="manage-chapters.php" class="btn btn-light shadow-sm px-4 css-import-chapters-8925b1">Cancel</a>
                            <button type="submit" class="btn btn-primary shadow-sm px-4 css-import-chapters-756f01">
