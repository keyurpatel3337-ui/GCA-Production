...
<link rel="stylesheet" href="<?php echo PORTAL_URL; ?>/assets/css/modules/dashboard/computer_operator_dashboard.css">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-sm bg-primary-subtle text-primary rounded-circle me-3 d-flex align-items-center justify-content-center computer_operator_dashboard-custom-1">
