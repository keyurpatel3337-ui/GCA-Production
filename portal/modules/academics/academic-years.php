    ...
    <div class="glass-card border-0 shadow-sm overflow-hidden">
        <div class="card-header bg-white py-3 px-4 border-bottom d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div id="deleteSelectedBtn" class="css-academic-years-224b51">
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-5">
                                <div class="empty-state py-4">
                                    ...
                                    <p class="text-muted mx-auto css-academic-years-c0dc2c">Begin by setting up your first
                        ...
                        <div class="col-12">
                            <div class="p-3 bg-light rounded-3 d-flex align-items-center justify-content-between">
                                ...
                                <div class="form-check form-switch p-0 m-0">
                                    <input type="checkbox" name="is_active" value="1" class="form-check-input ms-0 css-academic-years-ce054b"
