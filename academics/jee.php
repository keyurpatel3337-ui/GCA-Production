...
<body class="text-gray-800">
    ...
    <section class="relative py-12 md:py-24 overflow-hidden bg-gradient-to-b from-white via-blue-50/30 to-white">
        ...
        <div class="absolute top-1/3 right-20 w-32 h-32 bg-blue-200 rounded-full opacity-10 animate-float"
            style="animation-delay: 3s;"></div>
        <div class="absolute bottom-1/4 right-1/4 w-48 h-48 bg-indigo-100 rounded-full opacity-15 animate-float"
