    ...
    <section class="relative py-12 md:py-24 overflow-hidden bg-gradient-to-b from-white via-red-50/30 to-white">
        ...
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="text-center mb-12 md:mb-20">
                <div
                    class="inline-block px-3 md:px-4 py-1 md:py-1.5 mb-3 md:mb-4 bg-red-50 text-red-600 rounded-full text-xs md:text-sm font-bold tracking-wide uppercase">
                    Medical Excellence
                </div>
                <h1 class="text-3xl md:text-4xl lg:text-6xl font-black mb-3 md:mb-4">
                    <span class="bg-clip-text text-transparent bg-gradient-to-r from-red-600 to-orange-600">NEET
                        Preparation Program</span>
                </h1>
                <p class="text-gray-500 text-sm md:text-base lg:text-lg max-w-2xl mx-auto px-4">Empowering future
                    medical professionals to excel in national-level healthcare entrance exams.</p>
            </div>
            ...
            <div class="max-w-6xl mx-auto mb-12 md:mb-24">
                <div class="bg-white rounded-[2rem] md:rounded-[2.5rem] shadow-2xl overflow-hidden">
                    <div class="flex flex-col lg:flex-row">
                        <!-- Image Side -->
                        <div
                            class="lg:w-1/2 p-4 md:p-6 lg:p-8 bg-gradient-to-br from-red-50 to-orange-50/50 flex items-center justify-center">
                            <div class="relative group">
                                <div
                                    class="absolute -inset-1 bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl opacity-25 group-hover:opacity-40 blur transition duration-300">
                                </div>
                                <img src="../assets/images/neetpageimg.jpeg" alt="NEET Success"
                        ...
                        <div class="lg:w-1/2 p-6 md:p-8 lg:p-12 flex flex-col justify-center">
                            <h2 class="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Mastering Medical Entrance
                                Exams</h2>
                            <div class="space-y-4 md:space-y-6">
                                <p class="text-gray-700 text-sm md:text-base lg:text-lg leading-relaxed">
                                    ...
                                    offer dedicated classes for the <span
                                        class="text-red-600 font-semibold text-lg">NEET exam</span> (for Group B) and
                                    JEE (for Group A), ensuring every student receives specialized attention.
                                </p>
                                <p class="text-gray-700 text-sm md:text-base lg:text-lg leading-relaxed">
                                    Our platform features highly expert faculty with <span
                                        class="text-orange-600 font-semibold">15-20 years of experience</span> in
            ...
            <div class="max-w-4xl mx-auto mb-12 md:mb-24 text-center">
                <div
                    class="bg-gradient-to-br from-gray-900 to-red-950 rounded-[2rem] md:rounded-[2.5rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-gray-300 text-base md:text-lg leading-relaxed mb-8">
                            We take pride in our consistent results across Gujarat. Our integrated approach helps
                            students navigate the complexities of medical entrance with ease.
                        </p>
                        <div class="flex flex-wrap justify-center gap-6">
                            <div
                                ...
                                <div class="text-red-300 text-sm font-bold uppercase tracking-widest">Gujarat State
                                </div>
                            </div>
                            <div
                                class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 flex-1 min-w-[200px]">
                                <div class="text-3xl font-black text-white mb-2">100%</div>
                                <div class="text-red-300 text-sm font-bold uppercase tracking-widest">Syllabus Coverage
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="text-center">
                ...
                <a href="../contact.php"
                    class="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-red-600 to-orange-600 text-white font-bold rounded-full shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 group">
