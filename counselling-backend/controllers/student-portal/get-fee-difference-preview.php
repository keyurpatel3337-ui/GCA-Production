...
try {
    ...
    $html .= '<tr><td>Already Paid</td><td class="text-end">₹' . formatIndianCurrency($fees_already_paid) . '</td></tr>';
    $html .= '<tr><td>Current Pending</td><td class="text-end">₹' . formatIndianCurrency($current_net_fees - $fees_already_paid) . '</td></tr>';
    ...
    $html .= '<tr><td>Already Paid</td><td class="text-end">₹' . formatIndianCurrency($fees_already_paid) . '</td></tr>';
    $html .= '<tr><td><strong>New Pending Amount</strong></td><td class="text-end"><strong>₹' . formatIndianCurrency($new_pending) . '</strong></td></tr>';
